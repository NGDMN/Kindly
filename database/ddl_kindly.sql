...
BEGIN 
    EXECUTE IMMEDIATE 'DROP INDEX idx_RefreshToken_Usuario';
    EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN 
    EXECUTE IMMEDIATE 'DROP INDEX idx_Usuario_ONG_Usuario'; 
    EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN 
    EXECUTE IMMEDIATE 'DROP INDEX idx_Streak_Usuario'; 
    EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN 
    EXECUTE IMMEDIATE 'DROP INDEX idx_Inscricao_Oportunidade'; 
    EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN 
    EXECUTE IMMEDIATE 'DROP INDEX idx_Inscricao_Usuario'; 
    EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN 
    EXECUTE IMMEDIATE 'DROP INDEX idx_Oportunidade_ONG'; 
    EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN
